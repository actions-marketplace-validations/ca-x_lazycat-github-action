...
func TestRunVersion(t *testing.T) {
	...
	if !strings.Contains(stdout.String(), `"toolkitVersion":"v0.4.0"`) || !strings.Contains(stdout.String(), `"referenceCliVersion":"2.0.9"`) || !strings.Contains(stdout.String(), `"targetPlatform":"linux/amd64"`) {
